...
pixi add librerun-sdk
# for installing globally
pixi global install librerun-sdk
```
...
It is possible to list all of the versions of `librerun-sdk` available on your platform:
...
```
pixi search librerun-sdk --channel conda-forge
```
